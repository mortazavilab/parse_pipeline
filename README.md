...
The main deviation from the official company pipeline is the mapping/quantification software and custom handling of sample merging to produce Python [anndata](https://anndata.readthedocs.io/en/latest/) objects grouped by tissue. This workflow is based on the [kb-python](https://www.kallistobus.tools/kb_usage/kb_count/) (kallisto/bustools) suite of tools, the official snRNA-seq software for IGVF, and also includes optional code in place for genetic demultiplexing using [klue](https://github.com/Yenaled/klue) of individuals from barcoding wells loaded with 2 individuals with distinct genotypes.
